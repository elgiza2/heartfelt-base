 ...
 *
 *  586 real SaaS APIs from Nango's provider registry. Each entry carries the
...
export const NANGO_APPS: ApiApp[] = [
  ...
  },
  {
    ...
    "category": "data",
    "description": "HR API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/ukg-pro/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/ukg-pro/connect",
    "baseUrl": "https://${hostname}",
    "logo": "https://app.nango.dev/images/template-logos/ukg-pro.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Hostname",
  ...
  },
  {
    ...
    "category": "data",
    "description": "HR API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/workday/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/workday/connect",
    "baseUrl": "https://${hostname}/ccx/service/${tenant}",
    "logo": "https://app.nango.dev/images/template-logos/workday.svg",
    "credentials": [
      {
        "name": "tenant",
        "label": "Tenant",
  ...
  },
  {
    ...
    "docsUrl": "https://nango.dev/docs/api-integrations/3cx/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/3cx/connect",
    "baseUrl": "https://${domain}/xapi",
    "logo": "https://app.nango.dev/images/template-logos/3cx.svg",
    "credentials": [
      {
        "name": "domain",
        "label": "3CX Domain",
        "description": "Your 3CX instance domain",
        "example": "mycompany.3cx.us",
        "secret": false
      },
      {
        "name": "clientId",
        "label": "Client ID",
        "description": "The Client ID from your 3CX API integration",
        "example": "",
        "secret": false
      },
      {
        "name": "clientSecret",
        "label": "API Key",
        "description": "The API Key generated when creating your 3CX API integration",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "comms",
    "description": "marketing API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/active-campaign/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/active-campaign/connect",
    "baseUrl": "https://${hostname}/api",
    "logo": "https://app.nango.dev/images/template-logos/active-campaign.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Hostname",
  ...
  },
  {
    ...
    "category": "data",
    "description": "ERP API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/acumatica/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/acumatica/connect",
    "baseUrl": "https://${instanceUrl}",
    "logo": "https://app.nango.dev/images/template-logos/acumatica.svg",
    "credentials": [
      {
        "name": "instanceUrl",
        "label": "Instance URL",
      ...
      },
      {
        "name": "client_id",
        "label": "Client ID",
        "description": "The client ID assigned to your application, including the tenant suffix.",
        "example": "88358B02-A48D-A50E-F710-39C1636C30F6@MyTenant",
        "secret": false
      },
      {
        "name": "client_secret",
        "label": "Client Secret",
        "description": "The client secret created for your application in Acumatica ERP.",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/adobe-commerce/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/adobe-commerce/connect",
    "baseUrl": "https://${storeDomain}/rest/${storeCode}",
    "logo": "https://app.nango.dev/images/template-logos/adobe-commerce.svg",
    "credentials": [
      {
        "name": "storeCode",
        "label": "Store Code",
        "description": "The store code for your Adobe Commerce store",
        "example": "default",
        "secret": false
      },
      {
        "name": "storeDomain",
        "label": "Store Domain",
        "description": "The domain of your Adobe Commerce store",
      ...
      },
      {
        "name": "apiKey",
        "label": "Access Token",
        "description": "Your Adobe Commerce access token",
        "example": "3pgsytnpxbyz0waujkw9qllcjb79s379",
        "secret": true
      }
    ],
    "authTemplate": {
  ...
  },
  {
    ...
    "name": "Algolia",
    "category": "search",
    "description": "search API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/algolia/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/algolia/connect",
    "baseUrl": "https://${APP_ID}.algolia.net",
    "logo": "https://app.nango.dev/images/template-logos/algolia.svg",
    "credentials": [
      {
        "name": "APP_ID",
  ...
  },
  {
    ...
    "category": "data",
    "description": "analytics API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/altrata/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/altrata/connect",
    "baseUrl": "https://${hostname}",
    "logo": "https://app.nango.dev/images/template-logos/altrata.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Service Hostname",
        "description": "The Altrata service hostname to connect to.",
        "example": "events.altrata.com",
        "secret": false
      },
      {
        "name": "apiKey",
        "label": "API Key",
        "description": "Your Altrata API key.",
        "example": "mN3pQv8wLc2jXs5rKt4bGy6uFd1eAh7Z*******",
        "secret": true
      },
      {
        "name": "username",
        "label": "Username",
        "description": "Your Altrata account username.",
        "example": "john_doe",
        "secret": false
      },
      {
        "name": "password",
        "label": "Password",
        "description": "Your Altrata account password.",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "data",
    "description": "ERP API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/aspire/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/aspire/connect",
    "baseUrl": "https://${domain}",
    "logo": "https://app.nango.dev/images/template-logos/aspire.svg",
    "credentials": [
      {
        "name": "domain",
        "label": "Environment",
        "description": "The Aspire API environment to connect to.",
        "example": "",
        "secret": false
      },
      {
        "name": "clientId",
        "label": "Client ID",
        "description": "The Client ID generated for your Aspire application.",
        "example": "3f2a91c6-****-****-****-6d5e8a2b7c34",
        "secret": false
      },
      {
        "name": "secret",
        "label": "Secret",
        "description": "The Secret generated alongside the Client ID.",
        "example": "7hLp************************nHa5",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/athenahealth/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/athenahealth/connect",
    "baseUrl": "https://${subdomain}.platform.athenahealth.com",
    "logo": "https://app.nango.dev/images/template-logos/athenahealth.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "API Environment",
        "description": "The athenahealth environment to connect to.",
        "example": "",
        "secret": false
      },
      {
        "name": "client_id",
        "label": "Client ID",
        "description": "The client ID for your registered athenahealth app.",
        "example": "",
        "secret": false
      },
      {
        "name": "client_secret",
        "label": "Client Secret",
        "description": "The client secret for your registered athenahealth app.",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "comms",
    "description": "customer support API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/autotask/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/autotask/connect",
    "baseUrl": "https://${subdomain}.autotask.net/atservicesrest",
    "logo": "https://app.nango.dev/images/template-logos/autotask.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "AutoTask API Zone",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "customer support API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/auvik/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/auvik/connect",
    "baseUrl": "https://auvikapi.${region}.my.auvik.com",
    "logo": "https://app.nango.dev/images/template-logos/auvik.svg",
    "credentials": [
      {
        "name": "region",
        "label": "Region",
        "description": "The region of your Auvik account (visible in your browser address bar when logging into the Auvik web UI), e.g. us1, us2, eu1, lnx.",
        "example": "us1",
        "secret": false
      },
      {
        "name": "username",
        "label": "User Name / Account Email",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/avanan/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/avanan/connect",
    "baseUrl": "https://${subdomain}.avanan.net",
    "logo": "https://app.nango.dev/images/template-logos/avanan.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Subdomain",
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/aws-inspector2/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/aws-inspector2/connect",
    "baseUrl": "https://inspector2.${region}.amazonaws.com",
    "logo": "https://app.nango.dev/images/template-logos/aws-inspector2.svg",
    "credentials": [
      {
        "name": "region",
        "label": "Region",
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/aws-multi-service/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/aws-multi-service/connect",
    "baseUrl": "https://${service}.${region}.amazonaws.com",
    "logo": "https://app.nango.dev/images/template-logos/aws-multi-service.svg",
    "credentials": [
      {
        "name": "region",
        "label": "Region",
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/axiom/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/axiom/connect",
    "baseUrl": "https://${subdomain}.axiom.co",
    "logo": "https://app.nango.dev/images/template-logos/axiom.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Edge / region subdomain",
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/azure-devops/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/azure-devops/connect",
    "baseUrl": "https://${organizationUrl}",
    "logo": "https://app.nango.dev/images/template-logos/azure-devops.svg",
    "credentials": [
      {
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/back-market/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/back-market/connect",
    "baseUrl": "https://${platform}",
    "logo": "https://app.nango.dev/images/template-logos/back-market.svg",
    "credentials": [
      {
        "name": "platform",
        "label": "Back Market Platform",
        "description": "The Back Market platform and environment your seller account operates on",
        "example": "",
        "secret": false
      },
      {
        "name": "apiKey",
        "label": "API Token",
        "description": "The API token generated from the Integrations page.",
        "example": "MWY5YjNh******************************************************************************MwMg==",
        "secret": true
      }
    ],
    "authTemplate": {
  ...
  },
  {
    ...
    "category": "data",
    "description": "productivity API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/baserow/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/baserow/connect",
    "baseUrl": "${baseUrl}/api",
    "logo": "https://app.nango.dev/images/template-logos/baserow.svg",
    "credentials": [
      {
        "name": "baseUrl",
        "label": "Base URL",
        "description": "Your Baserow instance's base URL.",
        "example": "https://api.baserow.io",
        "secret": false
      },
      {
        "name": "apiKey",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "communication API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/beehiiv",
    "keyUrl": "https://nango.dev/docs/integrations/all/beehiiv",
    "baseUrl": "https://api.beehiiv.com/v2/publications/${publicationId}",
    "logo": "https://app.nango.dev/images/template-logos/beehiiv.svg",
    "credentials": [
      {
        "name": "publicationId",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "communication API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/bird/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/bird/connect",
    "baseUrl": "https://${subdomain}.bird.com",
    "logo": "https://app.nango.dev/images/template-logos/bird.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Subdomain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/bitdefender/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/bitdefender/connect",
    "baseUrl": "${ACCESS_URL}",
    "logo": "https://app.nango.dev/images/template-logos/bitdefender.svg",
    "credentials": [
      {
        "name": "ACCESS_URL",
        "label": "Access URL",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/booking-com",
    "keyUrl": "https://nango.dev/docs/integrations/all/booking-com",
    "baseUrl": "https://${environmentType}-xml.booking.com",
    "logo": "https://app.nango.dev/images/template-logos/booking-com.svg",
    "credentials": [
      {
  ...
  },
  {
    ...
    "category": "comms",
    "description": "communication API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/braze/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/braze/connect",
    "baseUrl": "https://rest.${instanceUrl}",
    "logo": "https://app.nango.dev/images/template-logos/braze.svg",
    "credentials": [
      {
        "name": "instanceUrl",
        "label": "Instance URL",
  ...
  },
  {
    ...
    "category": "data",
    "description": "ERP API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/cdw/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/cdw/connect",
    "baseUrl": "https://${baseUrl}",
    "logo": "https://app.nango.dev/images/template-logos/cdw.svg",
    "credentials": [
      {
        "name": "baseUrl",
        "label": "Environment",
        "description": "The CDW API gateway you want to connect to.",
        "example": "",
        "secret": false
      },
      {
        ...
        "description": "The subscription key from your CDW API Management developer portal account.",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/cerby/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/cerby/connect",
    "baseUrl": "https://${workspace}.cerby.com/api",
    "logo": "https://app.nango.dev/images/template-logos/cerby.svg",
    "credentials": [
      {
        "name": "workspace",
        "label": "Workspace",
        "description": "The subdomain of your Cerby workspace",
      ...
      },
      {
        "name": "apiKey",
        "label": "API Key",
        "description": "The API key for your Cerby workspace",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "finance",
    "description": "payments API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/chargebee/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/chargebee/connect",
    "baseUrl": "https://${subdomain}.chargebee.com",
    "logo": "https://app.nango.dev/images/template-logos/chargebee.svg",
    "credentials": [
      {
        "name": "subdomain",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "customer support API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/chattermill",
    "keyUrl": "https://nango.dev/docs/integrations/all/chattermill",
    "baseUrl": "https://${subdomain}.chattermill.com",
    "logo": "https://app.nango.dev/images/template-logos/chattermill.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Chattermill subdomain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/cisco-duo-admin/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/cisco-duo-admin/connect",
    "baseUrl": "https://${hostname}",
    "logo": "https://app.nango.dev/images/template-logos/cisco-duo-admin.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "API Hostname",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/cloudentity/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/cloudentity/connect",
    "baseUrl": "https://${tenantID}.${regionID}.authz.cloudentity.io/${tenantID}/${workspaceID}",
    "logo": "https://app.nango.dev/images/template-logos/cloudentity.svg",
    "credentials": [
      {
        "name": "workspaceID",
        "label": "Workspace ID",
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/codeclimate/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/codeclimate/connect",
    "baseUrl": "https://${domain}",
    "logo": "https://app.nango.dev/images/template-logos/codeclimate.svg",
    "credentials": [
      {
        "name": "domain",
        "label": "Domain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/commercetools/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/commercetools/connect",
    "baseUrl": "https://api.${region}.${cloudProvider}.commercetools.com/${projectKey}",
    "logo": "https://app.nango.dev/images/template-logos/commercetools.svg",
    "credentials": [
      {
        "name": "projectKey",
        "label": "Project Key",
  ...
  },
  {
    ...
    "category": "data",
    "description": "productivity API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/conductorone/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/conductorone/connect",
    "baseUrl": "https://${hostname}/api",
    "logo": "https://app.nango.dev/images/template-logos/conductorone.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Hostname",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/connectsecure/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/connectsecure/connect",
    "baseUrl": "https://${base_url}",
    "logo": "https://app.nango.dev/images/template-logos/connectsecure.svg",
    "credentials": [
      {
        "name": "base_url",
        "label": "Pod Host",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "customer support API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/connectwise-rmm/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/connectwise-rmm/connect",
    "baseUrl": "https://openapi.service.${subdomain}",
    "logo": "https://app.nango.dev/images/template-logos/connectwise-rmm.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "API Subdomain",
  ...
  },
  {
    ...
    "category": "finance",
    "description": "payments API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/coupa-compass",
    "keyUrl": "https://nango.dev/docs/integrations/all/coupa-compass",
    "baseUrl": "https://${instanceDomain}",
    "logo": "https://app.nango.dev/images/template-logos/coupa-compass.svg",
    "credentials": [
      {
        "name": "instanceDomain",
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/crowdstrike/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/crowdstrike/connect",
    "baseUrl": "https://${baseUrl}",
    "logo": "https://app.nango.dev/images/template-logos/crowdstrike.svg",
    "credentials": [
      {
        "name": "baseUrl",
        "label": "Base URL",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "marketing API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/customer-io/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/customer-io/connect",
    "baseUrl": "https://${subdomain}.customer.io",
    "logo": "https://app.nango.dev/images/template-logos/customer-io.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Subdomain",
  ...
  },
  {
    ...
    "category": "finance",
    "description": "payments API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/datacandy",
    "keyUrl": "https://nango.dev/docs/integrations/all/datacandy",
    "baseUrl": "https://${application_url}/api2",
    "logo": "https://app.nango.dev/images/template-logos/datacandy.svg",
    "credentials": [
      {
  ...
  },
  {
    ...
    "category": "data",
    "description": "analytics API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/datadog/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/datadog/connect",
    "baseUrl": "https://api.${siteParameter}/api",
    "logo": "https://app.nango.dev/images/template-logos/datadog.svg",
    "credentials": [
      {
        "name": "siteParameter",
        "label": "Site Parameter",
        "description": "The Datadog site for your account.",
        "example": "",
        "secret": false
      },
      {
  ...
  },
  {
    ...
    "category": "comms",
    "description": "communication API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/discourse",
    "keyUrl": "https://nango.dev/docs/integrations/all/discourse",
    "baseUrl": "https://${defaultHost}",
    "logo": "https://app.nango.dev/images/template-logos/discourse.svg",
    "credentials": [
      {
        "name": "defaultHost",
        "label": "Domain",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "customer support API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/dixa",
    "keyUrl": "https://nango.dev/docs/integrations/all/dixa",
    "baseUrl": "https://${apiType}.dixa.io",
    "logo": "https://app.nango.dev/images/template-logos/dixa.svg",
    "credentials": [
      {
        "name": "apiType",
        "label": "API Type",
        "description": "The Dixa API type to use for requests.",
        "example": "",
        "secret": false
      },
      {
  ...
  },
  {
    ...
    "category": "data",
    "description": "productivity API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/docuware/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/docuware/connect",
    "baseUrl": "https://${domain}/DocuWare/Platform",
    "logo": "https://app.nango.dev/images/template-logos/docuware.svg",
    "credentials": [
      {
        "name": "domain",
        "label": "Domain",
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/drupal/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/drupal/connect",
    "baseUrl": "https://${baseUrl}",
    "logo": "https://app.nango.dev/images/template-logos/drupal.svg",
    "credentials": [
      {
        "name": "baseUrl",
        "label": "Base Url",
  ...
  },
  {
    ...
    "category": "data",
    "description": "analytics API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/dynatrace/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/dynatrace/connect",
    "baseUrl": "https://${environmentId}.live.dynatrace.com",
    "logo": "https://app.nango.dev/images/template-logos/dynatrace.svg",
    "credentials": [
      {
        "name": "environmentId",
      ...
      },
      {
        ...
        "example": "dt0s01.ST2EY72KQINMH5***********.G3DFPBEJYMODIDAEX454M7YWB***************************",
        "secret": true
      }
    ],
    "authTemplate": {
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/entrata",
    "keyUrl": "https://nango.dev/docs/integrations/all/entrata",
    "baseUrl": "https://${subdomain}.entrata.com",
    "logo": "https://app.nango.dev/images/template-logos/entrata.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Entrata Domain",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "customer support API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/evaluagent",
    "keyUrl": "https://nango.dev/docs/integrations/all/evaluagent",
    "baseUrl": "https://${region}.evaluagent.com",
    "logo": "https://app.nango.dev/images/template-logos/evaluagent.svg",
    "credentials": [
      {
        "name": "region",
        "label": "Region",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "marketing API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/everflow/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/everflow/connect",
    "baseUrl": "https://${subdomain}.eflow.team",
    "logo": "https://app.nango.dev/images/template-logos/everflow.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Subdomain",
        "description": "Your Everflow API subdomain.",
        "example": "",
        "secret": false
      },
      {
        "name": "apiKey",
        "label": "API Key",
        "description": "The API key for your Everflow account.",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "data",
    "description": "productivity API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/fellow/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/fellow/connect",
    "baseUrl": "https://${subdomain}.fellow.app/api",
    "logo": "https://app.nango.dev/images/template-logos/fellow.svg",
    "credentials": [
      {
        "name": "subdomain",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "customer support API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/freshdesk/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/freshdesk/connect",
    "baseUrl": "https://${subdomain}.freshdesk.com",
    "logo": "https://app.nango.dev/images/template-logos/freshdesk.svg",
    "credentials": [
      {
        "name": "subdomain",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "customer support API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/freshservice/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/freshservice/connect",
    "baseUrl": "https://${subdomain}.freshservice.com",
    "logo": "https://app.nango.dev/images/template-logos/freshservice.svg",
    "credentials": [
      {
        "name": "subdomain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "HR API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/freshteam/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/freshteam/connect",
    "baseUrl": "https://${accountName}.freshteam.com",
    "logo": "https://app.nango.dev/images/template-logos/freshteam.svg",
    "credentials": [
      {
        "name": "accountName",
        "label": "Account Name",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "customer support API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/gainsight-cc/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/gainsight-cc/connect",
    "baseUrl": "https://api2-${region}.insided.com",
    "logo": "https://app.nango.dev/images/template-logos/gainsight-cc.svg",
    "credentials": [
      {
        "name": "region",
        "label": "Region",
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/gerrit/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/gerrit/connect",
    "baseUrl": "https://${host}",
    "logo": "https://app.nango.dev/images/template-logos/gerrit.svg",
    "credentials": [
      {
        "name": "host",
        "label": "Gerrit Host",
  ...
  },
  {
    ...
    "category": "data",
    "description": "productivity API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/glean/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/glean/connect",
    "baseUrl": "https://${serverUrl}",
    "logo": "https://app.nango.dev/images/template-logos/glean.svg",
    "credentials": [
      {
        "name": "serverUrl",
        "label": "Server URL",
        "description": "Your Glean instance's server URL.",
        "example": "acme-prod-be.glean.com",
        "secret": false
      },
      {
        "name": "apiKey",
        "label": "API Token",
        "description": "Your account API token.",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/grafana/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/grafana/connect",
    "baseUrl": "https://${domain}",
    "logo": "https://app.nango.dev/images/template-logos/grafana.svg",
    "credentials": [
      {
        "name": "domain",
        "label": "Domain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "productivity API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/grist/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/grist/connect",
    "baseUrl": "https://${environment}.getgrist.com",
    "logo": "https://app.nango.dev/images/template-logos/grist.svg",
    "credentials": [
      {
        "name": "environment",
        "label": "Environment",
  ...
  },
  {
    ...
    "category": "data",
    "description": "HR API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/haileyhr/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/haileyhr/connect",
    "baseUrl": "https://api.${environment}",
    "logo": "https://app.nango.dev/images/template-logos/haileyhr.svg",
    "credentials": [
      {
        "name": "environment",
        "label": "Environment",
        "description": "The Hailey HR environment to connect to.",
        "example": "",
        "secret": false
      },
      {
        "name": "apiKey",
        "label": "Personal Access Token",
        "description": "The personal access token for your Hailey HR account.",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "comms",
    "description": "customer support API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/halo-psa/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/halo-psa/connect",
    "baseUrl": "https://${hostname}/api",
    "logo": "https://app.nango.dev/images/template-logos/halo-psa.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Hostname",
  ...
  },
  {
    ...
    "category": "data",
    "description": "analytics API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/hex/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/hex/connect",
    "baseUrl": "https://${subdomain}.hex.tech/api",
    "logo": "https://app.nango.dev/images/template-logos/hex.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Subdomain",
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/immybot/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/immybot/connect",
    "baseUrl": "https://${instanceSubdomain}.immy.bot",
    "logo": "https://app.nango.dev/images/template-logos/immybot.svg",
    "credentials": [
      {
        "name": "instanceSubdomain",
        "label": "ImmyBot Instance Subdomain",
        "description": "The first segment of your ImmyBot instance URL.",
        "example": "acme",
        "secret": false
      },
      {
        "name": "client_id",
        "label": "Client ID",
        "description": "The Application client ID from the Microsoft Entra app registration.",
      ...
      },
      {
        "name": "client_secret",
        "label": "Client Secret",
        "description": "The client secret value from the Microsoft Entra app registration.",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "data",
    "description": "ERP API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/ingenious-build/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/ingenious-build/connect",
    "baseUrl": "https://${subdomain}.ingenious.build",
    "logo": "https://app.nango.dev/images/template-logos/ingenious-build.svg",
    "credentials": [
      {
        "name": "subdomain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "CRM API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/insightly",
    "keyUrl": "https://nango.dev/docs/integrations/all/insightly",
    "baseUrl": "https://api.${pod}.insightly.com",
    "logo": "https://app.nango.dev/images/template-logos/insightly.svg",
    "credentials": [
      {
        "name": "pod",
        "label": "Insightly Domain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "productivity API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/itglue/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/itglue/connect",
    "baseUrl": "https://${subdomain}.itglue.com",
    "logo": "https://app.nango.dev/images/template-logos/itglue.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Subdomain",
        "description": "Your IT Glue subdomain.",
        "example": "",
        "secret": false
      },
      {
  ...
  },
  {
    ...
    "category": "data",
    "description": "productivity API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/jiminny/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/jiminny/connect",
    "baseUrl": "https://app.jiminny.${region}/customer/api",
    "logo": "https://app.nango.dev/images/template-logos/jiminny.svg",
    "credentials": [
      {
        "name": "region",
        "label": "Region",
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/juniper-mist/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/juniper-mist/connect",
    "baseUrl": "https://${subdomain}.mist.com",
    "logo": "https://app.nango.dev/images/template-logos/juniper-mist.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "API Subdomain",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "customer support API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/kandji/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/kandji/connect",
    "baseUrl": "https://${subdomain}.kandji.io",
    "logo": "https://app.nango.dev/images/template-logos/kandji.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Subdomain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "productivity API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/kintone-user-api/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/kintone-user-api/connect",
    "baseUrl": "https://${subdomain}.kintone.com",
    "logo": "https://app.nango.dev/images/template-logos/kintone-user-api.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Subdomain",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "customer support API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/knowbe4/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/knowbe4/connect",
    "baseUrl": "https://${subdomain}.knowbe4.com",
    "logo": "https://app.nango.dev/images/template-logos/knowbe4.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Subdomain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "CRM API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/kustomer",
    "keyUrl": "https://nango.dev/docs/integrations/all/kustomer",
    "baseUrl": "https://${extension}.kustomerapp.com",
    "logo": "https://app.nango.dev/images/template-logos/kustomer.svg",
    "credentials": [
      {
        "name": "extension",
        "label": "Kustomer Domain",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "marketing API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/listmonk",
    "keyUrl": "https://nango.dev/docs/integrations/all/listmonk",
    "baseUrl": "https://${domain}/api",
    "logo": "https://app.nango.dev/images/template-logos/listmonk.svg",
    "credentials": [
      {
        "name": "domain",
        "label": "Domain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "analytics API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/looker/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/looker/connect",
    "baseUrl": "https://${hostname}/api",
    "logo": "https://app.nango.dev/images/template-logos/looker.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Looker Instance Hostname",
        "description": "Your Looker instance hostname",
      ...
      },
      {
        "name": "clientId",
        "label": "Client ID",
        "description": "Your Looker Client ID",
        "example": "",
        "secret": false
      },
      {
  ...
  },
  {
    ...
    "category": "comms",
    "description": "marketing API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/mailgun/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/mailgun/connect",
    "baseUrl": "https://${region}.mailgun.net",
    "logo": "https://app.nango.dev/images/template-logos/mailgun.svg",
    "credentials": [
      {
        "name": "region",
        "label": "Region",
  ...
  },
  {
    ...
    "category": "data",
    "description": "productivity API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/make/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/make/connect",
    "baseUrl": "https://${environmentUrl}/api/v2",
    "logo": "https://app.nango.dev/images/template-logos/make.svg",
    "credentials": [
      {
        "name": "environmentUrl",
        "label": "Domain",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "marketing API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/marketo/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/marketo/connect",
    "baseUrl": "https://${endpointURL}",
    "logo": "https://app.nango.dev/images/template-logos/marketo.svg",
    "credentials": [
      {
        "name": "endpointURL",
        "label": "Domain",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "communication API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/mattermost/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/mattermost/connect",
    "baseUrl": "https://${hostname}/api",
    "logo": "https://app.nango.dev/images/template-logos/mattermost.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Server URL",
  ...
  },
  {
    ...
    "category": "finance",
    "description": "payments API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/maxio/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/maxio/connect",
    "baseUrl": "https://${hostname}",
    "logo": "https://app.nango.dev/images/template-logos/maxio.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Hostname",
  ...
  },
  {
    ...
    "category": "search",
    "description": "search API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/meilisearch/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/meilisearch/connect",
    "baseUrl": "${instanceUrl}",
    "logo": "https://app.nango.dev/images/template-logos/meilisearch.svg",
    "credentials": [
      {
        "name": "instanceUrl",
        "label": "Instance URL",
        "description": "The base URL of your Meilisearch instance.",
      ...
      },
      {
        "name": "apiKey",
        "label": "API Key",
        "description": "A Meilisearch API key (not the master key).",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "data",
    "description": "ERP API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/microsoft-business-central/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/microsoft-business-central/connect",
    "baseUrl": "https://api.businesscentral.dynamics.com/v2.0/${tenantId}/${environmentName}",
    "logo": "https://app.nango.dev/images/template-logos/microsoft-business-central.svg",
    "credentials": [
      {
        "name": "environmentName",
        "label": "Enrivonment Name",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/modmed/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/modmed/connect",
    "baseUrl": "https://${environment}/firm/${firmUrlPrefix}",
    "logo": "https://app.nango.dev/images/template-logos/modmed.svg",
    "credentials": [
      {
        "name": "firmUrlPrefix",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "customer support API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/nable-ncentral/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/nable-ncentral/connect",
    "baseUrl": "https://${serverUrl}/api",
    "logo": "https://app.nango.dev/images/template-logos/nable-ncentral.svg",
    "credentials": [
      {
        "name": "serverUrl",
        "label": "N-central server URL",
        "description": "Your N-central server hostname.",
        "example": "ncentral.example.com",
        "secret": false
      },
      {
        "name": "userApiToken",
        "label": "User-API token",
        "description": "Your N-central User-API token (JWT)",
        "example": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJOX2NlbnRyYWwifQ.c2lnbmF0dXJl",
        "secret": true
      }
    ],
    "authTemplate": {},
  ...
  },
  {
    ...
    "category": "data",
    "description": "productivity API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/n8n/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/n8n/connect",
    "baseUrl": "${baseUrl}/api",
    "logo": "https://app.nango.dev/images/template-logos/n8n.svg",
    "credentials": [
      {
        "name": "baseUrl",
        "label": "Base URL",
        "description": "Your n8n instance's base URL.",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/nerdio/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/nerdio/connect",
    "baseUrl": "https://${hostname}/rest-api",
    "logo": "https://app.nango.dev/images/template-logos/nerdio.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Nerdio Instance URL",
        "description": "The hostname of your Nerdio Manager instance",
        "example": "web-admin-portal-3e3a4zfp4peo4.azurewebsites.net",
        "secret": false
      },
      {
        "name": "client_id",
  ...
  },
  {
    ...
    "docsUrl": "https://nango.dev/docs/integrations/all/next-cloud-ocs/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/next-cloud-ocs/connect",
    "baseUrl": "https://${domain}/ocs/v1.php",
    "logo": "https://app.nango.dev/images/template-logos/next-cloud-ocs.svg",
    "credentials": [
      {
        "name": "domain",
        "label": "Domain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "analytics API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/nexthink/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/nexthink/connect",
    "baseUrl": "https://${instance}.api.${region}.nexthink.cloud",
    "logo": "https://app.nango.dev/images/template-logos/nexthink.svg",
    "credentials": [
      {
        "name": "region",
        "label": "Region",
        "description": "Your Nexthink region",
        "example": "eu",
        "secret": false
      },
      {
        "name": "instance",
        "label": "Instance Name",
        "description": "The name of your Nexthink instance.",
        "example": "acme",
        "secret": false
      },
      {
        "name": "client_id",
        "label": "Client ID",
        "description": "Your Nexthink API Client ID.",
        "example": "",
        "secret": false
      },
      {
        "name": "client_secret",
        "label": "Client Secret",
        "description": "Your Nexthink API Client Secret.",
        "example": "",
        "secret": true
      }
    ],
    ...
    "credentials": [
      {
        "name": "instance",
        "label": "Instance",
        "description": "The hostname of the NinjaOne instance hosting your tenant.",
        "example": "",
        "secret": false
      },
      {
        "name": "client_id",
        "label": "Client ID",
        "description": "Your NinjaOne RMM OAuth Client ID",
        "example": "KTmhkNf1_dZZVPmIQTK_lH2DCNJ",
        "secret": false
      },
      {
        "name": "client_secret",
        "label": "Client Secret",
        "description": "Your NinjaOne RMM OAuth Client Secret",
        "example": "Ilfs4crKIU1t-5bde-2OMBsB9v3LGmfg82XJO7_q9TtgTnfNRmK",
        "secret": true
      }
    ],
    "authTemplate": {},
  ...
  },
  {
    ...
    "name": "NinjaOne SaaS Backup",
    "category": "data",
    "description": "file storage API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/ninjaone-saas-backup/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/ninjaone-saas-backup/connect",
    "baseUrl": "https://${apiHost}/api",
    "logo": "https://app.nango.dev/images/template-logos/ninjaone-saas-backup.svg",
    "credentials": [
      {
        "name": "apiHost",
        "label": "API Host",
        "description": "The host from your NinjaOne SaaS Backup API URL.",
        "example": "dropsuite.us",
        "secret": false
      },
      {
        "name": "apiKey",
        "label": "Authentication Token",
        "description": "The Authentication Token from NinjaOne SaaS Backup API Settings.",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "data",
    "description": "CRM API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/nocrm/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/nocrm/connect",
    "baseUrl": "https://${subdomain}.nocrm.io",
    "logo": "https://app.nango.dev/images/template-logos/nocrm.svg",
    "credentials": [
      {
        "name": "subdomain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "analytics API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/northbeam/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/northbeam/connect",
    "baseUrl": "https://${subdomain}.northbeam.io",
    "logo": "https://app.nango.dev/images/template-logos/northbeam.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "API Subdomain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "analytics API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/omni/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/omni/connect",
    "baseUrl": "https://${subdomain}.omniapp.co/api",
    "logo": "https://app.nango.dev/images/template-logos/omni.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Instance Subdomain",
        "description": "Your Omni instance subdomain.",
        "example": "acme",
        "secret": false
      },
      {
        "name": "apiKey",
        "label": "API Key",
        "description": "An Omni Organization API key or Personal Access Token (PAT).",
        "example": "omni_osk_40S5****************************************Aakd",
        "secret": true
      }
    ],
    "authTemplate": {
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/onelogin/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/onelogin/connect",
    "baseUrl": "https://${subdomain}.onelogin.com",
    "logo": "https://app.nango.dev/images/template-logos/onelogin.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Subdomain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "productivity API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/oomnitza/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/oomnitza/connect",
    "baseUrl": "https://${subdomain}.oomnitza.com",
    "logo": "https://app.nango.dev/images/template-logos/oomnitza.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Oomnitza Subdomain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/optum-real/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/optum-real/connect",
    "baseUrl": "https://${domain}",
    "logo": "https://app.nango.dev/images/template-logos/optum-real.svg",
    "credentials": [
      {
        "name": "domain",
        "label": "Environment",
        "description": "The Optum Real API environment to connect to.",
        "example": "",
        "secret": false
      },
      {
        "name": "client_id",
        "label": "Client ID",
        "description": "The Client ID issued via the Optum AI Marketplace for this environment.",
        "example": "f2aba07d-270c-42ba-8811-01af5f63d458",
        "secret": false
      },
      {
        "name": "client_secret",
        "label": "Client Secret",
        "description": "The Client Secret issued via the Optum AI Marketplace for this environment.",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/oracle-cloud-identity/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/oracle-cloud-identity/connect",
    "baseUrl": "https://${serviceInstance}.identity.oraclecloud.com",
    "logo": "https://app.nango.dev/images/template-logos/oracle-cloud-identity.svg",
    "credentials": [
      {
        "name": "serviceInstance",
        "label": "IDCS Service Instance",
        "description": "Your Oracle Identity Cloud Service instance identifier",
        "example": "idcs-1234567890abcdef1234567890abcdef",
        "secret": false
      },
      {
        "name": "apiKey",
  ...
  },
  {
    ...
    "category": "data",
    "description": "file storage API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/orange-logic/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/orange-logic/connect",
    "baseUrl": "https://${serverUrl}",
    "logo": "https://app.nango.dev/images/template-logos/orange-logic.svg",
    "credentials": [
      {
        "name": "serverUrl",
        "label": "Orange Logic Server URL",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/ory",
    "keyUrl": "https://nango.dev/docs/integrations/all/ory",
    "baseUrl": "https://${projectSlug}.projects.oryapis.com",
    "logo": "https://app.nango.dev/images/template-logos/ory.svg",
    "credentials": [
      {
        "name": "projectSlug",
        "label": "Project Slug",
  ...
  },
  {
    ...
    "category": "finance",
    "description": "payments API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/paddle/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/paddle/connect",
    "baseUrl": "https://${subdomain}.paddle.com",
    "logo": "https://app.nango.dev/images/template-logos/paddle.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Environment",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/paligo/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/paligo/connect",
    "baseUrl": "https://${subdomain}.paligoapp.com",
    "logo": "https://app.nango.dev/images/template-logos/paligo.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Paligo Instance Name",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "customer support API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/passportal/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/passportal/connect",
    "baseUrl": "https://${base_url}",
    "logo": "https://app.nango.dev/images/template-logos/passportal.svg",
    "credentials": [
      {
        "name": "base_url",
        "label": "Passportal Base URL",
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/phrase/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/phrase/connect",
    "baseUrl": "https://${hostname}",
    "logo": "https://app.nango.dev/images/template-logos/phrase.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Hostname",
        "description": "The API hostname for your Phrase data center.",
        "example": "",
        "secret": false
      },
      {
        "name": "apiKey",
        "label": "Access Token",
        "description": "The OAuth Access Token from your Phrase account.",
        "example": "aVdNWDZR****************************************************dDdN",
        "secret": true
      }
    ],
    "authTemplate": {
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/posthog/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/posthog/connect",
    "baseUrl": "https://${subdomain}.posthog.com",
    "logo": "https://app.nango.dev/images/template-logos/posthog.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Subdomain",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "customer support API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/prtg-classic/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/prtg-classic/connect",
    "baseUrl": "https://${host}",
    "logo": "https://app.nango.dev/images/template-logos/prtg-classic.svg",
    "credentials": [
      {
        "name": "host",
        "label": "Instance Host",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/pverify/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/pverify/connect",
    "baseUrl": "https://${apiHost}",
    "logo": "https://app.nango.dev/images/template-logos/pverify.svg",
    "credentials": [
      {
        "name": "apiHost",
        "label": "API Host",
        "description": "Your pVerify API hostname.",
        "example": "api.pverify.com",
        "secret": false
      },
      {
        "name": "clientId",
        "label": "Client ID",
        "description": "Your pVerify Client ID.",
        "example": "f1c2d3a4-5b67-4c89-ae01-123456789abc",
        "secret": false
      },
      {
        "name": "clientSecret",
        "label": "Client Secret",
        "description": "Your pVerify Client Secret.",
        "example": "aB3mNpQr7sXwYz2t***************",
        "secret": true
      }
    ],
    "authTemplate": {
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/qualia/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/qualia/connect",
    "baseUrl": "https://${subdomain}.qualia.io/api",
    "logo": "https://app.nango.dev/images/template-logos/qualia.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Subdomain",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "marketing API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/quentn/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/quentn/connect",
    "baseUrl": "https://${subdomain}.quentn.com/public/api",
    "logo": "https://app.nango.dev/images/template-logos/quentn.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Subdomain",
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/rapidapi",
    "keyUrl": "https://nango.dev/docs/integrations/all/rapidapi",
    "baseUrl": "https://${subdomain}.p.rapidapi.com",
    "logo": "https://app.nango.dev/images/template-logos/rapidapi.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Subdomain",
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/recall-ai/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/recall-ai/connect",
    "baseUrl": "https://${region}.recall.ai",
    "logo": "https://app.nango.dev/images/template-logos/recall-ai.svg",
    "credentials": [
      {
        "name": "region",
        "label": "Region",
  ...
  },
  {
    ...
    "category": "data",
    "description": "recruiting API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/recruitee/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/recruitee/connect",
    "baseUrl": "https://api.recruitee.com/c/${companyId}",
    "logo": "https://app.nango.dev/images/template-logos/recruitee.svg",
    "credentials": [
      {
        "name": "companyId",
        "label": "Company ID",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/redo/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/redo/connect",
    "baseUrl": "https://api.getredo.com/v2.2/stores/${storeId}",
    "logo": "https://app.nango.dev/images/template-logos/redo.svg",
    "credentials": [
      {
        "name": "storeId",
        "label": "Store ID",
        "description": "Your Redo Store ID.",
        "example": "aa902fb57cf83975317ea2a9",
        "secret": false
      },
      {
        "name": "apiKey",
        "label": "API Secret",
        "description": "Your Redo API secret.",
        "example": "redo_sk_****************************************************************",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/researchdesk/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/researchdesk/connect",
    "baseUrl": "https://${subdomain}.researchdesk.com",
    "logo": "https://app.nango.dev/images/template-logos/researchdesk.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Subdomain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/resova/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/resova/connect",
    "baseUrl": "https://api.resova.${region}",
    "logo": "https://app.nango.dev/images/template-logos/resova.svg",
    "credentials": [
      {
        "name": "region",
        "label": "Region",
        "description": "The datacenter region your Resova account is hosted in.",
        "example": "",
        "secret": false
      },
      {
        "name": "apiKey",
        "label": "API Key",
        "description": "The API key generated in your Resova account.",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "finance",
    "description": "accounting API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/sage-300-cre/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/sage-300-cre/connect",
    "baseUrl": "https://${serverUrl}",
    "logo": "https://app.nango.dev/images/template-logos/sage-300-cre.svg",
    "credentials": [
      {
        "name": "serverUrl",
        "label": "Server Hostname",
        "description": "Hostname of your Sage 300 CRE Web API server.",
        "example": "myserver.company.com",
        "secret": false
      },
      {
        "name": "dppKey",
        "label": "DPP License Key",
        "description": "Sage DPP license key (XML blob). Usually preconfigured — only fill in if asked to.",
        "example": "",
        "secret": true
      },
      {
        "name": "username",
        "label": "Username",
        "description": "Windows username, including the domain.",
        "example": "CORP\\jdoe",
        "secret": false
      },
      {
        "name": "password",
        "label": "Password",
        "description": "Password for the Windows user above.",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "data",
    "description": "HR API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/sage-hr/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/sage-hr/connect",
    "baseUrl": "https://${subdomain}.sage.hr",
    "logo": "https://app.nango.dev/images/template-logos/sage-hr.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Sage HR Subdomain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "ERP API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/sap-ariba/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/sap-ariba/connect",
    "baseUrl": "https://open${subdomain}.ariba.com",
    "logo": "https://app.nango.dev/images/template-logos/sap-ariba.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Subdomain",
        "description": "Your SAP Ariba API subdomain.",
        "example": "api-eu",
        "secret": false
      },
      {
  ...
  },
  {
    ...
    "category": "data",
    "description": "ERP API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/sap-business-one/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/sap-business-one/connect",
    "baseUrl": "https://${domain}",
    "logo": "https://app.nango.dev/images/template-logos/sap-business-one.svg",
    "credentials": [
      {
        "name": "domain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "ERP API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/sap-concur/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/sap-concur/connect",
    "baseUrl": "https://${region}.api.concursolutions.com",
    "logo": "https://app.nango.dev/images/template-logos/sap-concur.svg",
    "credentials": [
      {
        "name": "region",
        "label": "Region",
  ...
  },
  {
    ...
    "category": "data",
    "description": "ERP API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/sap-fieldglass/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/sap-fieldglass/connect",
    "baseUrl": "https://${domain}/api",
    "logo": "https://app.nango.dev/images/template-logos/sap-fieldglass.svg",
    "credentials": [
      {
        "name": "domain",
        "label": "Domain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "HR API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/sap-success-factors/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/sap-success-factors/connect",
    "baseUrl": "https://${apiServer}",
    "logo": "https://app.nango.dev/images/template-logos/sap-success-factors.svg",
    "credentials": [
      {
        "name": "apiServer",
        "label": "API Server",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/sellercloud/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/sellercloud/connect",
    "baseUrl": "${restApiEndpoint}",
    "logo": "https://app.nango.dev/images/template-logos/sellercloud.svg",
    "credentials": [
      {
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/sentinelone/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/sentinelone/connect",
    "baseUrl": "https://${hostname}",
    "logo": "https://app.nango.dev/images/template-logos/sentinelone.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Hostname",
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/sentry/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/sentry/connect",
    "baseUrl": "https://${hostname}/api",
    "logo": "https://app.nango.dev/images/template-logos/sentry.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Hostname",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/shopify-partner/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/shopify-partner/connect",
    "baseUrl": "https://partners.shopify.com/${partnerId}/api",
    "logo": "https://app.nango.dev/images/template-logos/shopify-partner.svg",
    "credentials": [
      {
        "name": "partnerId",
        "label": "Partner ID",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/shopline/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/shopline/connect",
    "baseUrl": "https://${handle}.myshopline.com",
    "logo": "https://app.nango.dev/images/template-logos/shopline.svg",
    "credentials": [
      {
        "name": "handle",
        "label": "Store Handle",
        "description": "The handle of your SHOPLINE store.",
        "example": "open001",
        "secret": false
      },
      {
        "name": "apiKey",
        "label": "Access Token",
        "description": "The access token generated when installing a private app to your store.",
        "example": "eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9.eyJhcHBJZCI6****************************************.L6F0WI**************************************",
        "secret": true
      }
    ],
    "authTemplate": {
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/shopworks/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/shopworks/connect",
    "baseUrl": "https://${hostname}",
    "logo": "https://app.nango.dev/images/template-logos/shopworks.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Hostname",
  ...
  },
  {
    ...
    "category": "data",
    "description": "productivity API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/snipe-it/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/snipe-it/connect",
    "baseUrl": "https://${hostname}/api",
    "logo": "https://app.nango.dev/images/template-logos/snipe-it.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Domain",
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/sophos-central/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/sophos-central/connect",
    "baseUrl": "${dataRegion}",
    "logo": "https://app.nango.dev/images/template-logos/sophos-central.svg",
    "credentials": [
      {
        "name": "dataRegion",
        "label": "DataRegion",
  ...
  },
  {
    ...
    "category": "data",
    "description": "analytics API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/splunk/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/splunk/connect",
    "baseUrl": "https://${hostname}",
    "logo": "https://app.nango.dev/images/template-logos/splunk.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Splunk host",
        "description": "Your Splunk management host and port.",
        "example": "my-splunk.example.com:8089",
        "secret": false
      },
      {
        "name": "apiKey",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/statamic/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/statamic/connect",
    "baseUrl": "https://${baseUrl}",
    "logo": "https://app.nango.dev/images/template-logos/statamic.svg",
    "credentials": [
      {
        "name": "baseUrl",
        "label": "Base URL",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/streamline-ai/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/streamline-ai/connect",
    "baseUrl": "https://${customer}.${domain}/api",
    "logo": "https://app.nango.dev/images/template-logos/streamline-ai.svg",
    "credentials": [
      {
        "name": "domain",
        "label": "Environment",
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/supabase/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/supabase/connect",
    "baseUrl": "https://${projectUrl}",
    "logo": "https://app.nango.dev/images/template-logos/supabase.svg",
    "credentials": [
      {
        "name": "projectUrl",
        "label": "Project URL",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/talentlms/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/talentlms/connect",
    "baseUrl": "https://${subdomain}.talentlms.com",
    "logo": "https://app.nango.dev/images/template-logos/talentlms.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Subdomain",
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/tanium/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/tanium/connect",
    "baseUrl": "https://${hostname}/api",
    "logo": "https://app.nango.dev/images/template-logos/tanium.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Hostname",
  ...
  },
  {
    ...
    "category": "data",
    "description": "recruiting API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/teamtailor",
    "keyUrl": "https://nango.dev/docs/integrations/all/teamtailor",
    "baseUrl": "https://${extension}.teamtailor.com",
    "logo": "https://app.nango.dev/images/template-logos/teamtailor.svg",
    "credentials": [
      {
        "name": "extension",
        "label": "Teamtailor Domain",
  ...
  },
  {
    ...
    "category": "comms",
    "description": "communication API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/telegram/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/telegram/connect",
    "baseUrl": "https://api.telegram.org/bot${apiKey}",
    "logo": "https://app.nango.dev/images/template-logos/telegram.svg",
    "credentials": [
      {
        "name": "apiKey",
        "label": "Bot Token",
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/thomson-reuters-legal-tracker/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/thomson-reuters-legal-tracker/connect",
    "baseUrl": "https://${hostname}/legal-tracker",
    "logo": "https://app.nango.dev/images/template-logos/thomson-reuters-legal-tracker.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Hostname",
        "description": "The regional API hostname for your Thomson Reuters account.",
        "example": "",
        "secret": false
      },
      {
        "name": "client_id",
        "label": "Client ID",
        "description": "The client ID from the App Management.",
        "example": "",
        "secret": false
      },
      {
        "name": "client_secret",
        "label": "Client Secret",
        "description": "The client secret from the App Management.",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "data",
    "description": "productivity API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/timify/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/timify/connect",
    "baseUrl": "https://${subdomain}.timify.com",
    "logo": "https://app.nango.dev/images/template-logos/timify.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Timify Subdomain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "ERP API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/toast/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/toast/connect",
    "baseUrl": "https://${subdomain}.toasttab.com",
    "logo": "https://app.nango.dev/images/template-logos/toast.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "API Subdomain",
        "description": "The Toast API subdomain for your environment.",
        "example": "ws-api",
        "secret": false
      },
      {
        "name": "clientId",
        "label": "Client ID",
        "description": "Your Toast API client identifier.",
        "example": "",
        "secret": false
      },
      {
        "name": "clientSecret",
        "label": "Client Secret",
        "description": "Your Toast API client secret.",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "data",
    "description": "productivity API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/trafft/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/trafft/connect",
    "baseUrl": "https://${subdomain}.admin.trafft.com/api",
    "logo": "https://app.nango.dev/images/template-logos/trafft.svg",
    "credentials": [
      {
        "name": "subdomain",
        "label": "Subdomain",
      ...
      },
      {
        "name": "client_id",
        "label": "Client ID",
        "description": "Your Trafft OAuth2 Client ID.",
        "example": "",
        "secret": false
      },
      {
        "name": "client_secret",
        "label": "Client Secret",
        "description": "Your Trafft OAuth2 Client Secret.",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/trigger-dev/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/trigger-dev/connect",
    "baseUrl": "https://${baseUrl}",
    "logo": "https://app.nango.dev/images/template-logos/trigger-dev.svg",
    "credentials": [
      {
        "name": "baseUrl",
        "label": "Hostname",
  ...
  },
  {
    ...
    "category": "finance",
    "description": "accounting API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/tripletex/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/tripletex/connect",
    "baseUrl": "https://${environment}",
    "logo": "https://app.nango.dev/images/template-logos/tripletex.svg",
    "credentials": [
      {
        "name": "environment",
        "label": "Environment",
        "description": "The Tripletex environment to connect to.",
        "example": "",
        "secret": false
      },
      {
        ...
        "description": "The consumer token issued by Tripletex for this environment.",
        "example": "eyJ0b2tlbklkIjoxLCJ0b2tlbiI6ImV4YW1wbGUtMDAwMC0wMDAwLTAwMDAtZXhhbXBsZSJ9",
        "secret": true
      },
      {
        "name": "employeeToken",
        "label": "Employee Token",
        "description": "The employee token the end user generates in their Tripletex tenant.",
        "example": "eyJ0b2tlbklkIjoxLCJ0b2tlbiI6ImV4YW1wbGUtMDAwMC0wMDAwLTAwMDAtZXhhbXBsZSJ9",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "data",
    "description": "HR API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/ukg-ready/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/ukg-ready/connect",
    "baseUrl": "https://${hostname}",
    "logo": "https://app.nango.dev/images/template-logos/ukg-ready.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Hostname",
  ...
  },
  {
    ...
    "category": "data",
    "description": "CRM API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/unipile",
    "keyUrl": "https://nango.dev/docs/integrations/all/unipile",
    "baseUrl": "https://${subdomain}.unipile.com:${port}",
    "logo": "https://app.nango.dev/images/template-logos/unipile.svg",
    "credentials": [
      {
        "name": "port",
        "label": "Port",
  ...
  },
  {
    ...
    "category": "data",
    "description": "CRM API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/veeva-vault/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/veeva-vault/connect",
    "baseUrl": "https://${subdomain}.veevavault.com/api/${version}",
    "logo": "https://app.nango.dev/images/template-logos/veeva-vault.svg",
    "credentials": [
      {
        "name": "version",
        "label": "Version",
      ...
      },
      {
        "name": "username",
        "label": "Username",
        "description": "Your Vault user name assigned by your administrator",
        "example": "",
        "secret": false
      },
      {
  ...
  },
  {
    ...
    "category": "data",
    "description": "Connect with your own API credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/vtex/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/vtex/connect",
    "baseUrl": "https://${accountName}.vtexcommercestable.com.br",
    "logo": "https://app.nango.dev/images/template-logos/vtex.svg",
    "credentials": [
      {
        "name": "accountName",
        "label": "Account Name",
  ...
  },
  {
    ...
    "category": "dev",
    "description": "developer tools API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/integrations/all/woocommerce/connect",
    "keyUrl": "https://nango.dev/docs/integrations/all/woocommerce/connect",
    "baseUrl": "https://${storeURL}",
    "logo": "https://app.nango.dev/images/template-logos/woocommerce.svg",
    "credentials": [
      {
        "name": "storeURL",
        "label": "Domain",
  ...
  },
  {
    ...
    "category": "data",
    "description": "productivity API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/workato/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/workato/connect",
    "baseUrl": "https://${hostname}/api",
    "logo": "https://app.nango.dev/images/template-logos/workato.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Data center hostname",
        "description": "The hostname of the data center your account is hosted in.",
        "example": "www.workato.com",
        "secret": false
      },
      {
        "name": "apiKey",
        "label": "API Token",
        "description": "The API token generated for your Workato API client.",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "data",
    "description": "HR API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/workramp/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/workramp/connect",
    "baseUrl": "https://${hostname}/api",
    "logo": "https://app.nango.dev/images/template-logos/workramp.svg",
    "credentials": [
      {
        "name": "hostname",
        "label": "Hostname",
        "description": "The WorkRamp hostname to connect to.",
        "example": "",
        "secret": false
      },
      {
        "name": "apiKey",
        "label": "API Key",
        "description": "The API key for your WorkRamp account",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "finance",
    "description": "accounting API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/yokoy/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/yokoy/connect",
    "baseUrl": "https://api.${environment}",
    "logo": "https://app.nango.dev/images/template-logos/yokoy.svg",
    "credentials": [
      {
        "name": "environment",
        "label": "Environment",
        "description": "Your Yokoy environment.",
        "example": "",
        "secret": false
      },
      {
        "name": "client_id",
        "label": "Client ID",
        "description": "Your Yokoy client ID.",
        "example": "",
        "secret": false
      },
      {
        "name": "client_secret",
        "label": "Client Secret",
        "description": "Your Yokoy client secret.",
        "example": "",
        "secret": true
      }
    ],
  ...
  },
  {
    ...
    "category": "comms",
    "description": "customer support API — connect with your own credentials",
    "docsUrl": "https://nango.dev/docs/api-integrations/zendesk-api-key/connect",
    "keyUrl": "https://nango.dev/docs/api-integrations/zendesk-api-key/connect",
    "baseUrl": "https://${subdomain}.zendesk.com",
    "logo": "https://app.nango.dev/images/template-logos/zendesk-api-key.svg",
    "credentials": [
      {
        "name": "subdomain",
